...
#       selectInput("model",
#                   label = "Select Model:",
#                   choices = c("Linear Regression", "Decision Tree", "Random Forest", "SVM", "Neural Network")),
#       br(),
...
#       selectInput("model",
#                   label = "Select Model:",
#                   choices = c("Linear Regression", "Decision Tree", "Random Forest", "SVR", 
...
# Include CSS for cloud animation
css <- "
.cloud-container {
  position: relative;
  width: 100%;
